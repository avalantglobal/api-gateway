        ...
        <div class="twelve wide computer twelve wide tablet column">
            ...
            <div>
                ...
                <div id="privacyPolicy" class="padding-double">
                    ...
                    <p>This section explains how API-G captures your personal information, purpose of capturing, and the retention of your personal information.</p>
                    <p>Please note that this policy is for reference only, and is applicable for the software as a product. Avalant., or its developers have no access to the information held within API-G. Please refer &ldquo;Disclaimer&rdquo; for more information.</p>
                    <p>Entities, organisations or individuals controlling the use and administration of API-G should create their own privacy policies setting out the manner in which data is controlled or processed by the respective entity, organisation or individual.</p>
                    <div class="margin-bottom-double"></div>
                    <h2 id="what-are-the-personal-information">What are the personal information &quest;</h2>
                    <p>API-G considers anything related to you as your personal information. This includes, but is not limited to,</p>
                    <ul>
                    ...
                    <p>However API-G does not consider the following as your personal information, and  uses this only for <strong>analytical purposes</strong>, since this information cannot be used to track you.</p>
                    <ul>
                    ...
                    <p>API-G collects your information to only serve your access requirements.</p>
                    <p>For example,</p>
                    <ul>
                        <li>API-G uses your IP address to detect any suspicious login attempt to your account. </li>
                        <li>API-G uses your First Name, Last Name, etc to provide rich and personalized information.</li>
                    </ul>
                    <div class="margin-bottom"></div>
                    <h3 id="tracking-technologies">Tracking Technologies</h3>
                    <p>API-G collects your information through the following,</p>
                    <ul>
                    ...
                    <p>API-G uses your personal information only for the following purposes.</p>
                    <ul>
                        <li>To provide you with a personalized user experience. API-G uses attributes such as your name for this purpose</li>
                        <li>To protect your account from unauthorized access or a potential hacking attempt. API-G use HTTP or TCP/IP Headers  for this purpose</li>
                        <ul>
                            <li>This includes,</li>
                            <ul>
                                <li>IP address,</li>
                        ...
                        <li>To derive statistical data for analytical purposes on system performance improvements. API-G will not keep any personal information after statistical calculations. Thus a statistical report has no means to identify an individual person</li>
                        <ul>
                            <li>API-G may use</li>
                            <ul>
                    ...
                    <p>API-G will disclose personal information only for the purposes for which it was collected (or for a use identified as consistent with that purpose), unless you have consented otherwise or where it is required by law.</p>
                    <div class="margin-bottom"></div>
                    <h3 id="legal-process">Legal process</h3>
                    <p>API-G  may disclose your personal information with or without your consent where it is required by law following the due and lawful process.</p>
                    <div class="margin-bottom-double"></div>
                    <h2 id="how-apim-store-or-keep-your-personal-information">How API-G keeps your personal information</h2>
                    <div class="margin-bottom"></div>
                    <h3 id="where-your-personal-information-stored">Where your personal information is stored</h3>
                    <p>API-G stores your personal information in secured databases. API-G exercises proper industry accepted security measures to protect the database where your personal information is held.</p>
                    <p>API-G may use encryption to keep your personal data with added level of security.</p>
                    <div class="margin-bottom"></div>
                    <h3 id="how-long-does-apim-keep-your-personal-information">How long does API-G keep your personal information &quest;</h3>
                    <p>API-G keep your personal data as long as you are an active user of our system. You can update your personal data at any time with the given self-care user portals.</p>
                    <div class="margin-bottom"></div>
                    ...
                    <p>You can additionally request to anonymize all traces of your activities that may have been retained by API-G  in Logs, Databases or Analytical storage.</p>
                    <div class="margin-bottom-double"></div>
                    <h2 id="about">About</h2>
                    <div class="margin-bottom"></div>
                    <h3 id="changes-to-this-policy">Changes to this policy</h3>
                    <p>Upgraded versions of API-G may contain changes to this policy and revisions to this policy will be packaged within such upgrades. Such changes would only apply to users who choose to use upgraded versions.</p>
